...
def tf_repositories(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/mirror.tensorflow.org/github.com/googleapis/google-cloud-cpp/archive/v0.21.0.tar.gz",
            "https://github.com/googleapis/google-cloud-cpp/archive/v0.21.0.tar.gz",
        ],
    )
