...
def tf_repositories(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        ...
        strip_prefix = "mkl-dnn-2.1.1",
        urls = [
            "https://storage.googleapis.com/mirror.tensorflow.org/github.com/intel/mkl-dnn/archive/v2.1.1.tar.gz",
            "https://github.com/intel/mkl-dnn/archive/v2.1.1.tar.gz",
        ],
    )
