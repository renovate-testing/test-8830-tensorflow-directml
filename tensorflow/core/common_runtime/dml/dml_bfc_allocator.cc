...
void DmlAllocator::HandleDeviceRemoval() { ReleaseFreeRegions(); }
...
void DmlAllocator::DeallocateRaw(void* ptr) {
  ...
  // After the device has been removed, deallocate memory as regions become free
  // since we won't be able to reuse it
